      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700">
              You have the right to ask us not to process your personal data for marketing purposes. You can exercise your right to prevent such processing by contacting us at airflowexpertllc@gmail.com.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700">
              Questions, comments, and requests regarding this privacy policy are welcomed and should be addressed to airflowexpertllc@gmail.com
            </p>
          </section>
